...
-> The life trait dataset for mammals (extracted and adapted from the Amniote Life History and EltonTraits databases) is available [here](https://github.com/olivierduron/Hemoplasma_infections/blob/main/data_mammal_traits.csv).
